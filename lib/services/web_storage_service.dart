...
class WebStorageService {
  ...
  // Simular Box<Medicine> con localStorage
  static Future<void> guardarMedicamento(Map<String, dynamic> med, {int? index}) async {
  ...
  static Future<void> guardarEntradaHistorial(Map<String, dynamic> entrada) async {
    final historial = _obtenerHistorial();
    final key = '${entrada['fecha']}|${entrada['nombreMedicamento']}';
  ...
  static void _guardarEnLocal(String key, dynamic data) {
    html.window.localStorage[key] = json.encode(data);
  }
}
